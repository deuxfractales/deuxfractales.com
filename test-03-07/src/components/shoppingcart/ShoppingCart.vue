  ...
  <div name="shopping-cart">
      ...
      <div v-if="cartSize > 0">
        <ul class="products">
          <li class="row" v-for="product in products">
            ...
            <div class="col right">
              <div class="remove" @click="removeItem(product)"></div>
            </div>
          </li>
        </ul>
      </div>
    ...
    <section class="container" v-if="cartSize > 0">
      <div class="promotion">
        ...
        <button type="button" class="promo-button">Apply</button>
      </div>
      ...
      <div class="checkout">
        <router-link to="/cart/confirmation">
